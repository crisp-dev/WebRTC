Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/crisp-dev/WebRTC
  spec.license      = { :type => 'BSD', :file => 'WebRTC.xcframework/LICENSE' }
  spec.author       = "Stasel"
  spec.ios.deployment_target = '12.0'
  spec.osx.deployment_target = '10.11'

  spec.source       = { :http => "https://github.com/crisp-dev/WebRTC/releases/download/131.0.0/WebRTC-M131.xcframework.zip" }
